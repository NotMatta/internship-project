    ...
    <div className="gap-9 flex flex-col h-full max-h-full">
      ...
      <div className="w-full overflow-y-scroll grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3">
        {applications && applications.map((application) => (
          <div key={application.id} className="p-4 border rounded-xl flex flex-col gap-4 justify-between w-full min-h-[300px] bg-accent">
            ...
            <div className="flex-grow text-sm">
              ...
              <div className="flex flex-wrap items-center gap-2">
                Password: 
                <p className="text-background bg-background px-2 rounded-xl hover:text-primary hover:bg-secondary">
